...
#ifndef ParameterValue_Plugin_567968995_h
#define ParameterValue_Plugin_567968995_h
...
namespace rcl_interfaces {
    namespace msg {
        namespace dds_ {
            ...
            #define ParameterValue_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ParameterValue_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ParameterValue_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ParameterValue_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ParameterValue_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ParameterValue_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ParameterValue_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ParameterValue_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ParameterValue_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ParameterValue_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            ParameterValue_Plugin_new(void);

            NDDSUSERDllExport extern void
            ParameterValue_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* ParameterValue_Plugin_567968995_h */

...
#ifndef GetParameterTypes_Plugin_2117690795_h
#define GetParameterTypes_Plugin_2117690795_h
...
namespace rcl_interfaces {
    namespace srv {
        namespace dds_ {
            ...
            #define GetParameterTypes_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define GetParameterTypes_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define GetParameterTypes_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define GetParameterTypes_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define GetParameterTypes_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern GetParameterTypes_Request_*
            ...
            GetParameterTypes_Request_PluginSupport_copy_data(
                GetParameterTypes_Request_ *out,
                const GetParameterTypes_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            GetParameterTypes_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            GetParameterTypes_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                GetParameterTypes_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            GetParameterTypes_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GetParameterTypes_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            GetParameterTypes_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            GetParameterTypes_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace rcl_interfaces {
    namespace srv {
        namespace dds_ {
            ...
            #define GetParameterTypes_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define GetParameterTypes_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define GetParameterTypes_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define GetParameterTypes_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define GetParameterTypes_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern GetParameterTypes_Response_*
            ...
            GetParameterTypes_Response_PluginSupport_copy_data(
                GetParameterTypes_Response_ *out,
                const GetParameterTypes_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            GetParameterTypes_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            GetParameterTypes_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                GetParameterTypes_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            GetParameterTypes_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GetParameterTypes_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            GetParameterTypes_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            GetParameterTypes_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* GetParameterTypes_Plugin_2117690795_h */
